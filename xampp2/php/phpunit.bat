...
if "%PHPBIN%" == "" set PHPBIN=D:\pc_storage_lfs\computer-science-original\First-Year\Database and Web App Dev\xampp2\php\.\php.exe
if not exist "%PHPBIN%" if "%PHP_PEAR_PHP_BIN%" neq "" goto USE_PEAR_PATH
GOTO RUN
:USE_PEAR_PATH
set PHPBIN=%PHP_PEAR_PHP_BIN%
:RUN
"%PHPBIN%" "D:\pc_storage_lfs\computer-science-original\First-Year\Database and Web App Dev\xampp2\php\phpunit" %*
