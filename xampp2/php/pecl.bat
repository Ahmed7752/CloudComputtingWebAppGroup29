...
FOR %%x IN ("D:\pc_storage_lfs\computer-science-original\First-Year\Database and Web App Dev\xampp2\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=D:\pc_storage_lfs\computer-science-original\First-Year\Database and Web App Dev\xampp2\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=D:\pc_storage_lfs\computer-science-original\First-Year\Database and Web App Dev\xampp2\php\"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=D:\pc_storage_lfs\computer-science-original\First-Year\Database and Web App Dev\xampp2\php\php.exe"
GOTO :INSTALLED
