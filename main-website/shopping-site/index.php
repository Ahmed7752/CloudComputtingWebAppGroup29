    ...
    <div class="container">  
        ...
        <div>
            <h1 class="index-header">Our promise</h1>
                <p class= "para">
                    The goal of this application is to allow the customer to make a shopping list of products. you can then take that shopping list with you to the supermarket and not worry about forgetting the essential item you need. 
                </p>
         </div>
         <div>
